...
begin
  ...
  begin
    ...
    try
      ...
      CatTools.Description := 'Przisionswerkzeuge und Montagezubehr';
  ...
  begin
    ...
    try
      ...
      CustRetail.Address := 'Mercedesstrae 120';
  ...
  begin
    ...
    try
      ...
      P1.Description := 'Przisions-Lasersensor IP67 fr Frderbnder';
    ...
    try
      ...
      P3.Name := 'Digitaler Drehmomentschlssel 10-100 Nm';
      P3.Description := 'Kalibrierter Drehmomentschlssel mit Bluetooth';
